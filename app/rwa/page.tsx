...
export default function RWAMarketplace() {
    ...
    return (
        <div className="min-h-screen bg-black relative overflow-hidden">
            ...
            <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-yellow-500/10 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-24 relative z-10">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 mb-6">
                        ...
                        <span className="text-sm font-bold text-orange-400 tracking-wider uppercase">RWA Marketplace</span>
                    </div>
                    ...
                    <p className="text-xl text-zinc-400 max-w-3xl mx-auto leading-relaxed">
                        Invest in tokenized <span className="text-white font-bold">real estate, bonds, invoices</span>, and cash-flow assets
                    </p>
                </div>
